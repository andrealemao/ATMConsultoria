...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String description = "A ATM Consultoria tem como missão apoiar organizações " +
                "que desejam alcançar o sucesso através de excelência em gestão e " +
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("andreluizalemao", "Facebook")
                .addInstagram("andreluizalemao", "Instagram")
                .addTwitter("andrelngoulart", "Twitter")
                .addYoutube("andreluizalemao", "YouTube")
